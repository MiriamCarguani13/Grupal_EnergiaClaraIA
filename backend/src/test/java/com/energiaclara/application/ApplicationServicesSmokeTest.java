...
class ApplicationServicesSmokeTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            ...
            .withBean(EnergyAiAnalysisPort.class, () -> request -> new com.energiaclara.application.energyops.dto.EnergyAiAnalysisOutcome(
                    false,
                    true,
                    request.kwh().compareTo(BigDecimal.valueOf(115)) > 0,
                    request.kwh().compareTo(BigDecimal.valueOf(115)) > 0
                            ? com.energiaclara.domain.energyops.AnomalySeverity.LOW
                            : null,
                    BigDecimal.ZERO,
                    BigDecimal.ZERO,
                    BigDecimal.ZERO,
