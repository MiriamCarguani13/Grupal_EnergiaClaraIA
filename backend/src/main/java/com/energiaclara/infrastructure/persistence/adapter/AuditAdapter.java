...
import com.energiaclara.infrastructure.persistence.repository.AuditChangeJpaRepository;
import com.energiaclara.infrastructure.persistence.repository.AuditLogJpaRepository;
...
public class AuditAdapter implements AuditPort {
    ...
    public void record(AuditEvent event) {
        try {
            ...
            entity.setSeveridad(event.status() == AuditEvent.AuditStatus.SUCCESS ? "BAJA" : "ALTA");
